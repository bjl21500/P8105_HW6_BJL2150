...
### Making of the city-state variablle and subsequent data manipulation.

``` r
# Making of the new variable 'city_state'. Also, created a binary variable from disposition and named this new observation 'solved',  Where 1 = "Closed by arrest" and 0 = "Open/ no arrest" and "Closed without arrest".
...
# This is the working dataframe where the 4 cities were filtered out successfully. I will be using this one ging forward.
...
![](P8105_HW6_BJL2150_files/figure-markdown_github/unnamed-chunk-8-2.png)
