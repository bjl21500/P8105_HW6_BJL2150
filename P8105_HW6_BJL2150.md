...
Th below code chunk is used to create the cross-validated predicted error and assess the differences.
...
In looking at Figure 3, the model that I proposed, named rmse\_bw\_linear, on the plot, had the highest root mean square of the three models. Again, the predictors added to this model are mother's age at delivery, mother's race, and average number of cigarettes smoked per day during pregnancy. As such, the conclusion can be made that this model inappropriate.
